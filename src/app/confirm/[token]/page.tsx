      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">Validating confirmation link...</p>
          </div>
        </div>
      </div>
    );
            ...
            <Alert variant="error">
              <div>
                ...
                <p className="mt-2 text-sm">
                  This link may have expired. Please try subscribing again 
            ...
            <div className="text-center">
              ...
              {state.email && (
                <p className="mt-2 text-sm text-gray-600">
                  Your subscription for <strong>{state.email}</strong> has been confirmed.
                </p>
              )}
              <p className="mt-2 text-sm text-gray-600">
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="space-y-4">
            <p className="text-sm text-gray-600">
              ...
              emails from us. You can unsubscribe at any time using the link 
              in our emails.
            </p>
          ...
          <div className="mt-6 text-xs text-gray-500 text-center">
            <p>
              This confirms your consent to receive marketing emails. 
