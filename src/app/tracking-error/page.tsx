...
export default function TrackingErrorPage() {
  ...
  const errorMessages = {
    ...
    'invalid-destination': {
      ...
      suggestion: 'For security reasons, we cannot redirect you to this destination.',
    },
    'server-error': {
      title: 'Server Error',
    ...
    'unknown': {
      ...
      suggestion: 'Please try again later or contact support if you continue to experience issues.',
    },
  };
