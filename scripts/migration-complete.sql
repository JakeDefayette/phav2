-- Complete Migration: Create all enums and core tables for PHA platform
-- Description: Combined migration with enums and core tables with proper error handling
-- Author: Database Schema Implementation
-- Date: 2025-05-26

-- ============================================================================
-- ENUM TYPES (from Migration 1)
-- ============================================================================
...
-- Email sends (detailed tracking) - CREATE OR RECREATE WITH ALL COLUMNS
DO $$
BEGIN
  ...
  CREATE TABLE email_sends (
    ...
    -- Add constraint inline to ensure it's created with the table
